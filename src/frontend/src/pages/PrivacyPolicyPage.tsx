    ...
    <div style={{ backgroundColor: "#0B0B0B" }}>
      ...
      <section className="pt-32 pb-20" style={{ backgroundColor: "#121212" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#B0B0B0] font-inter text-base">
            ...
            <div className="space-y-10 text-[#B0B0B0] font-inter">
              ...
              >
                ...
                <p className="text-sm leading-relaxed">
                  GrowthNexora ("we", "our", or "us") is committed to protecting
              ...
              >
                ...
                <p className="text-sm leading-relaxed">
                  ...
                  necessary to provide our services or as required by law. We
                  may share your information with trusted service providers who
                  assist us in operating our business, subject to
              ...
              >
                ...
                <p className="text-sm leading-relaxed">
                  ...
                  help us analyze web traffic and remember your preferences. You
